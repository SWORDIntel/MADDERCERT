...
const chain = require('./chainValidation');
...
const certs = {
    ...
    // New features
    generateCRL: crl.generateCRL,
    revokeCertificate: crl.revokeCertificate,
    startOCSPResponder: ocsp.startOCSPResponder,
    validateChain: chain.validateChain,
    isRenewalNeeded: renewal.isRenewalNeeded,
    renewCertificate: renewal.renewCertificate,
    scanAndRenewCertificates: renewal.scanAndRenewCertificates,
    queryAuditLog: audit.queryAuditLog
};
